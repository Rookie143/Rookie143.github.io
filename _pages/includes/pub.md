...
- ``ICML 2026`` [Dual-branch Robust Unlearnable Examples](https://arxiv.org/abs/2605.01718), Xianlong Wang, **Hangtao Zhang**, Wenbo Pan, Ziqi Zhou, Changsong Jiang, Li Zeng, Xiaohua Jia
...
- ``IEEE Transactions on Multimedia`` [SegTrans: Transferable Adversarial Examples for Segmentation Models](https://ojs.aaai.org/index.php/AAAI/article/view/32870), Yufei Song, Ziqi Zhou, Qi Lu, **Hangtao Zhang**, Yifan Hu, Lulu Xue, Shengshan Hu, Minghui Li, Leo Yu Zhang
